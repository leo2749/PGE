...
enum AccessEvent { CARGAR_VUELO, CARGAR_RESERVA, DETALLE_RESERVA };
...
SistemaReservas detalle_reservas(SistemaReservas s) {
    s.ver_reservas();
    return s;
}

SistemaReservas cargar_resrva(SistemaReservas s) {
    s.cargar_reserva();
    return s;
}

SistemaReservas cargar_vuelo(SistemaReservas s) {
    s.crear_nuevo_vuelo();
    return s;
}

void accessControlLoop(SistemaReservas s, std::map<AccessEvent, std::function<SistemaReservas(SistemaReservas)>>& eventTable) {
...
int main() {
    ...
    std::map<AccessEvent, std::function<SistemaReservas(SistemaReservas)>> eventTable;
    eventTable[DETALLE_RESERVA] = detalle_reservas;
    eventTable[CARGAR_RESERVA] = cargar_resrva;
    eventTable[CARGAR_VUELO] = cargar_vuelo;
    ...
    while (!salir) {
        ...
        case 4:
            ...
            break;
        case 5:
            accessControlLoop(sistema, eventTable);
            break;
        case 6:
            salir = true;
            break;
